...
if __name__ == "__main__":
    objfilepath='/home/tencent_go/dataset/ycb-tools/models/ycb/052_extra_large_clamp/poisson/textured.obj'
    points = read_obj_vertices(objfilepath)
    point_cloud = o3d.geometry.PointCloud()
    point_cloud.points = o3d.utility.Vector3dVector(points)

    filepath='area_get/output/2023-09-02/23-56-21.txt'#读取抓取点和抓取配置
