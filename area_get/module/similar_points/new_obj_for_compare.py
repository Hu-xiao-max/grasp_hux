...
if __name__ == "__main__":
    ...
    compare_objfilepath='/root/HUX/dataset/ycb/052_extra_large_clamp/poisson/textured.obj'
    ...
    for obj in obj_list:
        obj = obj.split('.')[0]
        filepath='/root/HUX/grasp_hux/area_get/output/2023-09-02/21-10/'+ obj + '.txt'#读取抓取点和抓取配置
        objfilepath= datasetpath + '/' + obj + '/poisson/textured.obj'
        ...
        with open("/root/HUX/grasp_hux/area_get/module/similar_points/fpfh_similarity_results.txt", "w") as output_file:
